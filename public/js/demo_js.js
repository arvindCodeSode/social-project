//this is for top sidenav and overlay
...
//                     x=navigator.geolocation.getCurrentPosition(showPosition,showError);
//                     console.log(x);
//                 }else{
//                     x="Broswer don't support";
//                 }
//             }
...
//             x="Code: "+error.code+"User don't want to share own location";
//             break;
//             case error.POSITION_UNAVIALABEL:
//             x="Code: "+error.code+"location data is not available";
//             break;
//             case error.TIMEOUT:
//             x="Code: "+error.code+"Postion Timeout";
//             break;
//             case error.UNKNOWN_ERROR:
//             x="Code: "+error.code+"There is soething unknown error";
//             break;
//         }
//     }
"use_strict"
...
$("#post-upload").click(function(event){
    ...
    $.ajax({
        ...
        method:"post",
        data:{post_u_text:post_u_text,image_u_f:image_u_f,image_name:image_name,csrfe:csrfe,type:type},
        success:function(responce){
